...
$b->setOptions(array('login_path' => 'login', 'always_use_default_target_path' => true, 'default_target_path' => '/redirect-login', 'use_referer' => true, 'target_path_parameter' => '_target_path'));
