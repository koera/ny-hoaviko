...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\AbonnerType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\AbonnerType']) ? $this->services['AppBundle\Form\AbonnerType'] : $this->services['AppBundle\Form\AbonnerType'] = new \AppBundle\Form\AbonnerType()) && false ?: '_'};
