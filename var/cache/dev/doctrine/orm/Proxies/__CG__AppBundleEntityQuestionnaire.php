 ...
 */
class Questionnaire extends \AppBundle\Entity\Questionnaire implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Questionnaire' . "\0" . 'question', '' . "\0" . 'AppBundle\\Entity\\Questionnaire' . "\0" . 'code', '' . "\0" . 'AppBundle\\Entity\\Questionnaire' . "\0" . 'responses'];
        }
